...
{
  "$end", "error", "$undefined", "a", "b", "c", "e", "f", "g", "h", "i",
  "k", "d", "j", "$accept", "Game", "CH1", "$@1", "CH2", "$@2", "CH3",
  "$@3", "CH4", "$@4", "BONUS", YY_NULLPTR
};
#endif
...
{
       7,     6,    11,    12,    13,    14,     0,     8,    17,     0,
      21,    18,    22,     1,     2
};

static const yytype_int8 yycheck[] =
{
       5,     0,     6,     7,     8,     9,    -1,    12,    10,    -1,
      11,    13,    13,     3,     4
};
...
{
       0,     3,     4,    15,    16,    17,     0,     5,    12,    18,
      19,     6,     7,     8,     9,    20,    21,    10,    13,    22,
      23,    11,    13,    24
};
...
{
       0,    14,    15,    17,    16,    16,    19,    18,    18,    21,
      20,    20,    20,    20,    23,    22,    22,    24,    24
};
